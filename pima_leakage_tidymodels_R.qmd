...
---
title: "Pima – Leakage, Imputation & Scaling with tidymodels (R)"
format:
  html:
    toc: true
    code-fold: true
...
1. Show **leakage with scaling** (standardisation).
2. Show **leakage with mean imputation** of `insulin`.
3. Show the **correct, leak-free approach** using **recipes + workflows** in tidymodels.
...
## 4. Doing it properly with tidymodels recipes (impute + scale)

Finally, we let **recipes** handle both:
